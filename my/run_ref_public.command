#!/usr/bin/env bash
# 独自生成UI（Gradio）参照音声版 ネットワーク公開用起動スクリプト
...
echo "======================================"
echo "🌐 ネットワーク公開モードでGradio（参照音声版）を起動します"
if [ -n "$LOCAL_IP" ]; then
    echo "▶ 他のPCからのアクセス用URL: http://${LOCAL_IP}:7863"
else
    echo "▶ 他のPCからは、このPCのIPアドレスにポート7863でアクセスしてください"
fi
echo "======================================"
